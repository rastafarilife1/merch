(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".gallery__slider2")) new swiper_core_Swiper(".gallery__slider2", {
            modules: [ Navigation, Thumb, EffectFade ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".gallery__slider3")) new swiper_core_Swiper(".gallery__slider3", {
            modules: [ Navigation, Thumb, EffectFade ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".gallery__slider4")) new swiper_core_Swiper(".gallery__slider4", {
            modules: [ Navigation, Thumb, EffectFade ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".gallery__slider5")) new swiper_core_Swiper(".gallery__slider5", {
            modules: [ Navigation, Thumb, EffectFade ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".reviews-item__slider")) new swiper_core_Swiper(".reviews-item__slider", {
